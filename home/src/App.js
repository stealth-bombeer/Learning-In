    ...
    <Router>
      ...
      <div className="content">
        <Routes>
          ...
          <Route
            path="/ranklist"
            element={user ? <RankList /> : <Navigate to="/" />}
          />
          ...
          <Route
            ...
            element={
              user ? (
                <Scorecard score={score} count={count} setCount={setCount} />
              ) : (
                <Navigate to="/" />
              )
            }
          ...
          <Route
            ...
            element={
              user ? (
                <Practice fetchQuestions={fetchQuestions} />
              ) : (
                <Navigate to="/" />
              )
            }
          ...
          <Route
            path="/funfact"
            element={user ? <FunFact /> : <Navigate to="/" />}
          />
          <Route
            path="/codetimer"
            element={
          ...
          <Route
            ...
            element={
              user ? (
                <Result score1={score1} setScore1={setScore1} />
              ) : (
                <Navigate to="/" />
              )
            }
