    ...
    <div className="bg-white w-full h-full">
      <div className="grid grid-cols-6 gap-4">
        <div className="col-span-1">
          <img
            src="https://www.internationalstudentinsurance.com/images/competition-trophy.png"
            className="w-64 mt-96"
          />
          <img
            src="https://cdn1.iconfinder.com/data/icons/school-icons-2/512/trophy_award_ribon-512.png"
      ...
      <img src='https://www.internationalstudentinsurance.com/images/competition-trophy.png' />
        ...
        <div className="col-span-1">
          <img
            src="https://cdn4.iconfinder.com/data/icons/education-282/512/medal-512.png"
            className="w-64 mt-64"
          />
          <img
            src="https://static.vecteezy.com/system/resources/previews/000/667/541/original/little-boy-student-ready-for-school.jpg"
            className="w-64 mt-64"
          />
        </div>
      </div>
