      ...
      <div className="create col-span-2 pl-60 pt-8 ">
          ...
          <div class="flex flex-col md:flex-row md:max-w-xl p-16 rounded-lg bg-white shadow-lg">
            <form>
              <div>
                ...
                <div>
                  <label className="bold pt-10 text-2xl font-Playfair Display  font-bold text-cyan-800 text-area:width-">
                    ADD THE QUESTION:
                  </label>
                  <textarea
                    className="w-500%
        ...
        m-0"
              ...
              <div className="grid grid-cols-2 gap-4 pt-8">
                <div>
                  <label className="bold text-lg font-merriweather italic font-bold text-cyan-800 textarea-rounded">
                    Add option A:
                  </label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="bold text-lg font-merriweather italic font-bold text-cyan-800">
                    Add option B:
                  </label>
                  <input
                    type="text"
              ...
              <div>
                <label className="bold text-lg pt-5 font-merriweather italic font-bold text-cyan-800">
