    ...
    <div className='dhr  mt-10 '>
       <div className='text-purple-800 font-sass font-bold text-2xl'>
        <div className='font-sass font-bold mb-4 inline-flex '>
          <img src=" https://cdn.onlinewebfonts.com/svg/img_555124.png" className='w-6 h-6 mr-2'/>
            <div>Name: {name}</div>
         </div>
        <div className='mb-4 '>
        <img src="https://tse2.mm.bing.net/th?id=OIP.ON_Kljd6kCfX_PoCbVHq_gHaHa&pid=Api&P=0" className='w-6 h-6 mr-2 inline-flex'/>
        <div>E-mail id:  {email}</div>
        </div>
        <div className='mb-4'>
        {/* <p>Total score: {totsc}</p>
        <p>Level: {Math.floor(totsc / 10) + 1}</p> */}
         <img src="https://tse4.mm.bing.net/th?id=OIP.gWBcSlRD9VJxJHR00082XQHaG-&pid=Api&P=0" className='w-6 h-6 mr-2 inline-flex'/>
        <div>Number of tests given:   {n}</div>
        </div>
        <div>
        <img src="https://tse4.mm.bing.net/th?id=OIP.uov9voDMN3E3dMUlrQxHwAHaHa&pid=Api&P=0" className='w-6 h-6 mr-2 inline-flex'/>
