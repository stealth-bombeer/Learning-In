        ...
        <div class=" w-full mt-10">
          <div class=" rounded-lg bg-white  px-10 shadow-lg">
            <div class="flex  justify-center mt-10  ">
              <img
                src="https://yt3.ggpht.com/a/AATXAJxu3xHexNk-ICMClSdMVan3IBEwvqjuJOB9aQ=s900-c-k-c0xffffffff-no-rj-mo"
                className="w-96"
              />
            </div>
            <div>
            ...
            <div>
              <button
                className="inline-block mt-10 mb-10 px-4 ml-4 py-2.5 bg-cyan-700 text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:bg-cyan-500 hover:shadow-lg focus:bg-cyan-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-cyan-800 active:shadow-lg transition duration-150 ease-in-out"
